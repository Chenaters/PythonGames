# The import call in line 2 is needed because filedialog
# is a module that belongs to tkinter, not a function that
# is defined in tkinter, so filedialog doesn't automatically
# get imported with everything else when we call
# from tkinter import *
# in line 1. Our Load Grid and Save Grid buttons
# won't work without the import in line 2.
...
class SudokuCell(Label):
    ...
    def __init__(self, master, coord):
        ...
        self.possibles = set(range(1, 10))  # set of possible fills
        # set up listeners
